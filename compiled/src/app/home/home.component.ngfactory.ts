...
import * as import10 from '../../../../src/app/login-signup/login/login.component';
import * as import11 from '../login-signup/login/login.component.ngfactory';
...
class View_HomeComponent_Host0 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._HomeComponent_0_3 = new Wrapper_HomeComponent(this.injectorGet(import8.AppState,this.parentIndex));
...
export class View_HomeComponent0 extends import1.AppView<import0.HomeComponent> {
  ...
  _text_3:any;
  _el_4:any;
  compView_4:import1.AppView<import10.LoginComponent>;
  _LoginComponent_4_3:import11.Wrapper_LoginComponent;
  _text_5:any;
  _text_6:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import1.AppView<any>,parentIndex:number,parentElement:any) {
  ...
  createInternal(rootSelector:string):import7.ComponentRef<any> {
    ...
    this._el_4 = import3.createRenderElement(this.renderer,this._el_2,'login',import3.EMPTY_INLINE_ARRAY,(null as any));
    this.compView_4 = new import11.View_LoginComponent0(this.viewUtils,this,4,this._el_4);
    this._LoginComponent_4_3 = new import11.Wrapper_LoginComponent(this.parentView.injectorGet(import8.AppState,this.parentIndex));
    this.compView_4.create(this._LoginComponent_4_3.context);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import10.LoginComponent) && (4 === requestNodeIndex))) { return this._LoginComponent_4_3.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    this._LoginComponent_4_3.ngDoCheck(this,this._el_4,throwOnChange);
